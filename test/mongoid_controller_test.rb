...
module Rails3JQueryAutocomplete
  module Test
    module Mongoid
      ...
      class ActorsControllersTest < ActionController::TestCase
        ...
        context "the autocomplete gem" do
          ...
          should "respond with expected json" do
            ...
            assert_equal(json_response.first["id"], @movie1.id.to_s)
          end
          ...
          should "ignore case of search term and results" do
            @game = @movie_class.create(:name => 'aLpHa')
          ...
          should "be able to customize what is displayed" do
            ...
            assert_equal(@movie1.id.to_s, json_response.first["id"])
          end
        end
      end
